...
Related: [[concepts/ai-filmmaking-india]], [[entities/neuralgarage]]. The lip-sync facial alteration and voice cloning at the core of the technology are direct applications of [[concepts/diffusion-models]] and score-based generative modeling on the image and audio sides — see [[concepts/score-based-generative-models]] for the underlying model family.

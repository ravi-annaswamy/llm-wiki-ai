...
A deterministic ordinary differential equation associated with a stochastic differential equation, constructed to share the **same time-marginal distributions** as the SDE at every time t. Introduced in Yang Song's ICLR 2021 SDE paper on [[concepts/score-based-generative-models]]. The probability flow ODE turns any score-based / diffusion generative model into a continuous normalizing flow, unlocking **exact log-likelihood computation** and deterministic sampling.

...
The test-oracle concept on this page is the same idea specialized to code-correctness scientific computing. For the full cross-cutting analysis — instances, features, predictions, and where the pattern doesn't apply — see **[[analyses/producer-filter-pattern]]**.
